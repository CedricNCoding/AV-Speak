...
4. **Activer la licence** (onglet Licence) avec le code fourni par le vendeur
5. Ajouter les contacts (onglet Contacts) : manuellement ou import CSV
6. Personnaliser l'apparence (onglet Apparence) : logo, couleurs, phrase d'annonce
7. Configurer les notifications email/SMS si necessaire (onglet Notifications)
8. Activer le registre de securite si souhaite (onglet Registre)
